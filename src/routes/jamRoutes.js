...
module.exports = app => {
	...
	app.post("/api/jams/search", async (req, res) => {
	...
	app.post("/api/jams/create", requireLogin, async (req, res) => {
	...
	app.post("/api/jams/update", requireLogin, async (req, res) => {
		Jam.update(
			{
				_id: req.body.jamId
			},
	...
	app.post("/api/jams/delete", requireLogin, async (req, res) => {
	...
	app.post("/api/jams/details", async (req, res) => {
		Jam.findOne({ _id: req.body.jamId }, async (err, jam) => {
			if (jam) {
				res.json(jam);
			}
